...
" coc config from github ------ END-------

" Status line 
" Set the statusline format
set statusline=%<%f\ %h%m%r%=%-14.(%l,%c%V%)\ %P

" Highlight the active window's statusline
highlight StatusLine term=reverse cterm=reverse

" Highlight the inactive windows' statusline
...
let g:indentLine_char = '▏'            " Character used for indentation
